...
class RecipeTest < ActiveSupport::TestCase
    ...
    def setup
        @chef = Chef.create(chefname: "Bob", email: "bobo@example.com")
    ...
    test "name length should be not too short" do
        @recipe.name = "a" * 4
        assert_not @recipe.valid?
    end
    ...
    test "description length should be not too long" do
        @recipe.description = "a" * 501
        assert_not @recipe.valid?
    end
    
    test "description length should be not too short" do
